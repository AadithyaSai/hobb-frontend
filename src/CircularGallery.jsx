...
import MASQU from "./Benefits/MASQU.webp";
import SECURE from "./Benefits/SECURE.jpg";
import TAMPER from "./Benefits/TAMPER.jpg";
import PLAIN from "./Benefits/PLAIN.jpg";
import {
  Renderer,
  Camera,
  Transform,
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: PLAIN, text: 'Flexible Plaintexts' },
      { image: MASQU, text: 'Attack Resistant' },
      { image: SECURE, text: 'Secure Encryption' },
      { image: TAMPER, text: 'Tamper Proof' }
    ]
