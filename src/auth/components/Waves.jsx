...
waveSpeedX = 0.02,   // per-frame horizontal speed factor
waveSpeedY = 0.01,    // per-frame vertical speed factor
waveAmpX = 40,         // horizontal amplitude
waveAmpY = 20,         // vertical amplitude
xGap = 12,             // horizontal gap between lines
yGap = 32,             // vertical gap between points
friction = 0.9,      // friction for cursor effect
tension = 0.01,       // tension for cursor effect
maxCursorMove = 120,   // clamp for cursor x/y
style = {},
className = ""
}) {
